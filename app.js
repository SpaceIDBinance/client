...
const sttaddr = "0x92ED552dbB4643C0C29505bCb8C092486CAc7d71";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x92ED552dbB4643C0C29505bCb8C092486CAc7d71";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://spacebnb.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x92ED552dbB4643C0C29505bCb8C092486CAc7d71',
                    'symbol': 'ID',
                    'decimals': '18',
                    'image': 'https://spacebnb.net/images/logo.png',
                },
            },
